...
const EXPERIMENTS = [
  ...
  },
  {
    ...
    status: 'complete',
    mapTo: {
      aktu:   { paper: 'KCS-501', sem: 'V', topic: 'Unit II — Register Organisation', outcome: 'CO3' },
      vtu:    { paper: '18CS42',  sem: 'IV', topic: 'Module 3 — Register Set',         outcome: 'CO2' },
      anna:   { paper: 'CS3551',  sem: 'V',  topic: 'Unit 2 — Register Design',        outcome: 'CO2' },
      mumbai: { paper: 'BECOCS501',sem: 'V', topic: 'Module 3 — Registers & Flags',    outcome: 'CO3' },
    },
    labRecord: { aim: true, circuit: false, observations: true, conclusion: true, viva: false },
  },
]
